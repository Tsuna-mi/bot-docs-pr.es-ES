...
Cuando esté listo, puede volver a publicar los orígenes en Azure. [Siga estos pasos para obtener información sobre cómo volver a publicar el bot en Azure](../bot-service-build-download-source-code.md#publish-node-bot-source-code-to-azure)
