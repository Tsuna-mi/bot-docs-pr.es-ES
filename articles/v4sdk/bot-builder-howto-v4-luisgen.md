...
Puede usar la [herramienta LUISGen](https://github.com/Microsoft/botbuilder-tools/tree/master/LUISGen) para crear clases que faciliten la extracción de las entidades de LUIS en el código del bot.
